...
<main style="display: flex;">
  ...
  :data="tableDatalist" style=" width: 90%;    margin-top: 30px;
    height: 80%;
   "
...
type="selection" width="55" />
  ...
  ">
    <div>  <el-button @click="toggleAllSelection"
      >全选</el-button
    >
    
    <el-button type="danger" @click="SelectDelet" :icon="Delete" circle /></div>
...
::v-deep .el-table--border .el-table__inner-wrapper::after, .el-table--border::after, .el-table--border::before {
