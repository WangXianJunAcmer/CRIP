  ...
  setup() {
    ...
    onMounted(() => {
      ...
      const addEventOnElem = (
        elem: Element | NodeListOf<Element> | Window,
        type: string,
        callback: () => void
      ) => {
...
<template>
        ...
        <div class="container">
          <div class="hero-content">
            ...
            <div class="hero-card" data-reveal="left">
              <p class="title-lg card-text">搜索医生 诊所 医院等</p>
              ...
              <div class="wrapper">
                ...
                <button class="btn has-before" @click="goToSearch">
          ...
          <ul class="service-list">
            <li>
              <div class="service-card" data-reveal="bottom">
                ...
                <p class="card-text">帮助患者恢复正常的生活和社会活动。</p>
            ...
            <li>
              <div class="service-card" data-reveal="bottom">
                ...
                <p class="card-text">专注于研究和治疗与肺部相关的疾病。</p>
  ...
  >
    <ArrowUpBold
      style="width: 1em; height: 1em; margin-right: 1px; border-radius: 50%"
    />
  </a>
</template>
